package com.example.fas.config.security; // Gói của bạn

import com.example.fas.model.enums.oauth2.AuthProvider;
import com.example.fas.model.enums.user.UserStatus;
import com.example.fas.repositories.services.serviceImpl.exceptions.user.exists.AccountSocialExistsException;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        return new DefaultOAuth2User(
                List.of(new SimpleGrantedAuthority(user.getRole().getRoleName() != null ? user.getRole().getRoleName() : "USER")),
                customAttributes,
                nameAttributeKey);
    }
